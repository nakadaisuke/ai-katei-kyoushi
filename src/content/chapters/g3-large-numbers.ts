  ...
  assessmentProblems: [
    ...
    },
    {
      ...
      figure: {
        ...
        majorStep: 10000,
        minorStep: 2000,
        markers: [{ value: 8000, label: "ア" }],
      },
      steps: ["1めもりは2000を表す", "0から1めもり分すすんだ位置は2000、4めもり分すすんだ位置がア", "2000 × 4 = 8000"],
      tags: ["数直線"],
    },
    {
      id: "g3-largenum-normal-17",
      difficulty: "normal",
      question: "下の数直線で、イの位置が表す数はいくつですか。",
      answer: "35000",
      figure: {
        kind: "number-line",
        min: 0,
        ...
        majorStep: 10000,
        minorStep: 2000,
        markers: [{ value: 35000, label: "イ" }],
      },
      steps: ["30000と40000の真ん中の位置がイ", "(30000 + 40000) ÷ 2 = 35000"],
      tags: ["数直線"],
    },
    {
      id: "g3-largenum-hard-9",
      difficulty: "hard",
      ...
      figure: {
        ...
        majorStep: 10000,
        minorStep: 2000,
        markers: [{ value: 64000, label: "ウ" }],
      },
      steps: ["1めもりは2000を表す", "60000から2めもり分すすんだ位置がウ", "60000 + 2000 × 2 = 64000"],
      tags: ["数直線"],
    },
  ],
};
